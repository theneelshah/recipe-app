...
public class UploadRecipe extends AppCompatActivity {
    ...
    public void uploadImage() {
        ...
        storageReference.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(UploadRecipe.this, e.getMessage(), Toast.LENGTH_SHORT);
                progressDialog.dismiss();
            }
        });
    }
    ...
    public void uploadRecipe() {
        ...
        if(txt_price.getText().toString() == "" || txt_description.getText().toString() == "" || txt_price.getText().toString() == "" ) {
            Toast.makeText(UploadRecipe.this, "Please enter all the fields", Toast.LENGTH_LONG).show();
            return;
        }
